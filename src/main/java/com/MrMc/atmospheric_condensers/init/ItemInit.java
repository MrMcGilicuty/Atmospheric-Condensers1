...
import com.MrMc.atmospheric_condensers.item.FuelType;
...
public class ItemInit {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, AtmosphericCondensers.MOD_ID);

    public static final RegistryObject<Item> BITUMEN_ITEM = register("raw_bitumen",
            () -> new FuelType(new Item.Properties().tab(AtmosphericCondensers.ATMO_TAB)));

    public static final RegistryObject<Item> TRANS_ITEM = register("transistor",
            () -> new Item(new Item.Properties().tab(AtmosphericCondensers.ATMO_TAB).stacksTo(1).durability(12)));

    public static final RegistryObject<Item> NITROGEN_BUCKET = register("liquid_nitrogen_bucket",
            () -> new BucketItem(GasInit.LIQUID_NITROGEN_FLUID, new Item.Properties().tab(AtmosphericCondensers.ATMO_TAB).stacksTo(1)));

    public static final RegistryObject<Item> TRANS_HEAD = register("transistor_head",
            () -> new Item(new Item.Properties().tab(AtmosphericCondensers.ATMO_TAB)));
