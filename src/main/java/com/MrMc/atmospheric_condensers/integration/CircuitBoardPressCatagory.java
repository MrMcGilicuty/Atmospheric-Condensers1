...
public class CircuitBoardPressCatagory implements IRecipeCategory<CircuitPressRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(AtmosphericCondensers.MOD_ID, "pressing");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(AtmosphericCondensers.MOD_ID, "textures/gui/circuit_board_press_jei_gui.png");
