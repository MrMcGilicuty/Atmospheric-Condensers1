...
public class CondenserHousingCatagory implements IRecipeCategory<Condenser1Recipe> {
    public final static ResourceLocation UID = new ResourceLocation(AtmosphericCondensers.MOD_ID, "condensing");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(AtmosphericCondensers.MOD_ID, "textures/gui/condenser_housing_jei_gui.png");
