...
public class TransistorFactoryRecipeCatagory implements IRecipeCategory<TransistorFactoryRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(atmosphericcondensers1.MOD_ID, "transistor_fabrication");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(atmosphericcondensers1.MOD_ID, "textures/gui/transistor_factory_jei_gui.png");
