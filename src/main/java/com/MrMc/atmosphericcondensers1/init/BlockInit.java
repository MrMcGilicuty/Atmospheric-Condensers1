...
import com.MrMc.atmosphericcondensers1.block.CircuitBoardPressBlock;
import com.MrMc.atmosphericcondensers1.block.CondenserHousingBlock;
import com.MrMc.atmosphericcondensers1.block.TransistorFactoryBlock;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> BITUMEN_ORE = register("bitumen_ore",
            ...
            object -> () -> new BlockItem(object.get(), new Item.Properties().tab(atmosphericcondensers1.ATMO_TAB)));
